...
const EN: Dict = {
  ...
  'launcher.opt.port': 'Port',
  'launcher.opt.maxtok': 'Max tokens',
  'launcher.opt.extra': 'Extra args',
  'launcher.opt.extra.ph': 'e.g. --flash-attn --temp 0.6',
  'launcher.opt.hint.unlimited': '0 = unlimited',
  'launcher.settings': 'Per-model settings',
...
const ZH: Dict = {
  ...
  'launcher.opt.port': '端口',
  'launcher.opt.maxtok': '生成上限',
  'launcher.opt.extra': '额外参数',
  'launcher.opt.extra.ph': '如 --flash-attn --temp 0.6',
  'launcher.opt.hint.unlimited': '0=不限',
  'launcher.settings': '单模型参数',
  'launcher.saved': '已保存',
